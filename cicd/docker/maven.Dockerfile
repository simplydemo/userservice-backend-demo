# This is a multi-stage maven.Dockerfile for Spring Boot Applications made as a Layered Jar
# Build the image with: 'docker build -f maven.Dockerfile -t [IMAGE_NAME]:[TAG] .'
